...
| Android host/hotspot/session | BR-JRN-001–002; BR-OPS-001–005; PR-JRN-001–008 | FR-JRN-001–012 | US-JRN-001–010; UC-JRN-001–002; UC-OFF-001 | SEC-DEV-001–008; NFR-MOB-001–008 | ADR-001 (Recommended); ADR-002 (Decision required; P1-DEC-010 approved for bounded implementation); ADR-008 (Recommended; project-owner PWA/edge boundary approved) | Configuration-driven PC-hosted local HTTP entry helper, field record and [ADR-002 deployment analysis](../adr/ADR-002-CONDUCTOR-EDGE-DEPLOYMENT-ANALYSIS.md) | `print-local-journey-url.mjs`; `HOTSPOT_PHYSICAL_TEST_PLAN.md`; `SPRINT_5_FIELD_CONNECTIVITY_RECORD.md`; `PHASE_1_APPROVED_DECISIONS.md` P1-DEC-010; `ANDROID_EDGE_IMPLEMENTATION_READINESS.md` | Hybrid Android-companion/cloud and Passenger-PWA boundary recorded; controlled synchronization, device/security/contract gates, Android-hosted services, QR host UI and no-internet/multi-passenger proof remain pending |
