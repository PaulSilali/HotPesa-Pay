...
| Missing-callback reconciliation and expiry | BR-PAY-008–010; PR-PAY-007–008 | FR-PAY-011–013; FR-REC-007–009 | US-REC-001–003; UC-REC-001 | SEC-PAY-006–009; NFR-AVAIL-001 | ADR-005; ADR-011 (Recommended for approval); ADR-016; OD-FRS-004 | Manual development reconciliation; bounded scheduled reconciliation policy approved for Phase 1 | `payments.service.test.ts` missing callback, expiry and late evidence | Scheduled worker implementation pending; retry exhaustion is `review-required`, not expiry |
