...
| Android host/hotspot/session | BR-JRN-001–002; BR-OPS-001–005; PR-JRN-001–008 | FR-JRN-001–012 | US-JRN-001–010; UC-JRN-001–002; UC-OFF-001 | SEC-DEV-001–008; NFR-MOB-001–008 | ADR-001 (Recommended); ADR-002 (Decision required); ADR-008 (Recommended) | Configuration-driven PC-hosted local HTTP entry helper and field-test records | `print-local-journey-url.mjs`; `HOTSPOT_PHYSICAL_TEST_PLAN.md`; `SPRINT_5_FIELD_CONNECTIVITY_RECORD.md` | PC-hosted configuration ready; Android-hosted services, QR host UI, device matrix and physical hotspot proof remain blocked by decisions/evidence |
